...
| V1-CDC | Data Engineering + Infrastructure Workers | RDS PostgreSQL, DMS full load/CDC and current-state lakehouse flow | In progress: implementation and plan preparation | Terraform plan approval before CDC apply |
