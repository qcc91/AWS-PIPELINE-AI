...
| V1-BATCH-LAKEHOUSE | Data Engineering + Infrastructure Workers | CSV happy path and minimum Bronze/Silver/Gold Iceberg | Implemented and Manager-reviewed; real plan 14/0/0 awaits Human approval | Next Terraform plan approval |
